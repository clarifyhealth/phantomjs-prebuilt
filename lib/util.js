...
var DEFAULT_CDN = 'https://github.com/clarifyhealth/phantomjs-prebuilt/releases/download/2.1.16'
...
function getDownloadSpec() {
  ...
  if (platform === 'linux' && arch === 'x64') {
    ...
    checksum = 'fe0aa0007030cbace4057bf7d144f9297cd865f1b62e4e2c5803bf5c041ecdca'
  } else if (platform === 'linux' && arch == 'ia32') {
    downloadUrl += 'linux-i686.tar.bz2'
    checksum = '80e03cfeb22cc4dfe4e73b68ab81c9fdd7c78968cfd5358e6af33960464f15e3'
  } else if (platform === 'darwin') {
    downloadUrl += 'macosx.zip'
    checksum = '8455ee7a048dcc13a26cc959c4b58ffeae3c3b4a852c8987ba87b545f90390fe'
  } else if (platform === 'win32') {
    downloadUrl += 'windows.zip'
    checksum = 'c66809880853f87f8390a43bbeedcb39b441078259614dad0b56ef1efafad3d7'
  } else {
    return null
  }
